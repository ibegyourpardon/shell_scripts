...
wget http://file.mageface.com/download/vpn/pptpd-1.4.0-1.el6.$arch.rpm
...
echo "vpn pptpd mageface.com *" >> /etc/ppp/chap-secrets
...
echo "done username��vpn   password��mageface.com"
echo "add user �� vi /etc/ppp/chap-secrets"
